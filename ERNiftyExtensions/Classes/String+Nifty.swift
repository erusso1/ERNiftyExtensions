...
extension String {
  ...
  public func heightFromBoundedWidth(_ width:CGFloat, font:UIFont) -> CGFloat {
    ...
    let maxHeight = ceil((self as NSString).boundingRect(with: CGSize(width: width, height: CGFloat(Int.max)), options: [NSStringDrawingOptions.usesLineFragmentOrigin], attributes: [NSAttributedStringKey.font : font], context: nil).height + 8.0)
